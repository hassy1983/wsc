<div class="services index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('screenshot_url'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($service['Service']['service_url']); ?>&nbsp;</td>
		<td><?php echo h($service['Service']['logo_url']); ?>&nbsp;</td>
		<td><?php echo h($service['Service']['screenshot_url']); ?>&nbsp;</td>
